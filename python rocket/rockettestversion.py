...
while (r < earth):
  starting_x = input("what is the starting x point?  (type 0 for Earth launch) ")
  starting_y = input("what is the starting y point? (type 6378100 for Earth launch) ")
...
results = open("rocketresults " + str(timeframe) +", " + str(velocity) + ", " + str(mass), "w")
